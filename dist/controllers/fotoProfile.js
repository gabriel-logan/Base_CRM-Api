...
const upload = _multer2.default.call(void 0, _multerConfig2.default).single('formFotoProfile');
  ...
  store(req, res) {
    return upload(req, res, async (err) => {
      ...
      try {
        ...
        const foto = await _FotoProfile2.default.create({ originalname, filename, user_id });
...
exports. default = new FotoProfileController();
